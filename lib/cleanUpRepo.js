...
module.exports = function (config, package) {
    ...
    this.cleanUpRepo = () => {
        ...
        files.forEach(file => {
            ...
            if (filePath.dir.indexOf('aura') >= 0) {
                name = filePath.dir.substring(filePath.dir.indexOf('aura')) + '/';
            }
            else if (filePath.base.indexOf('-meta.xml') >= 0) {
            ...
            if (config.package && filePath.ext === '.workflow') {
                found = false;
            }
